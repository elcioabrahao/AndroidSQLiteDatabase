package br.usjt.cursoandroid.androidsqlitedatabase.database;
...
public class DBMS extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_FILE = "db_script.sql";
    private static final String DATABASE_NAME = "cliente.db";
